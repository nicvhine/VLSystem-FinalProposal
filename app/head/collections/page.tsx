...
export default function CollectionsPage() {
  ...
  const filteredCollections = collections.filter(collection => {
    ...
    const matchesCollector = activeCollector === 'All' || collection.collector === activeCollector;
      ...
      <div className="flex items-center gap-2 mb-6">
          ...
          <div className="bg-white">
            <table className="min-w-full">
              <thead>
                <tr>
                  <th className="bg-gray-100 px-6 py-3 text-left text-sm font-medium text-gray-600 first:rounded-l-md">ID</th>
                  <th className="bg-gray-100 px-6 py-3 text-left text-sm font-medium text-gray-600">Name</th>
                  <th className="bg-gray-100 px-6 py-3 text-left text-sm font-medium text-gray-600">Balance</th>
                  <th className="bg-gray-100 px-6 py-3 text-left text-sm font-medium text-gray-600">Past Due</th>
                  <th className="bg-gray-100 px-6 py-3 text-left text-sm font-medium text-gray-600">Period Amount</th>
                  <th className="bg-gray-100 px-6 py-3 text-left text-sm font-medium text-gray-600">Paid Amount</th>
                  <th className="bg-gray-100 px-6 py-3 text-left text-sm font-medium text-gray-600">Status</th>
                  <th className="bg-gray-100 px-6 py-3 text-left text-sm font-medium text-gray-600">Collector</th>
                  <th className="bg-gray-100 px-6 py-3 text-left text-sm font-medium text-gray-600 last:rounded-r-md">Note</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                {filteredCollections.map((collection) => (
                  ...
                  >
                    <td className="px-6 py-4 text-sm text-gray-600">{collection.id}</td>
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2.5 py-1 rounded-md text-sm  ${getStatusColor(collection.status)}`}>
                        {collection.status}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-600">{collection.collector}</td>
