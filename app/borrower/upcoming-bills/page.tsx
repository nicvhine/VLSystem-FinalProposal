...
export default function UpcomingBillPage() {
    ...
    <div className="min-h-screen bg-gray-50 relative">
        ...
        <main className="max-w-7xl mx-auto px-6 py-10">
            ...
            {/* Bill 1 */}
            <div className="bg-white p-4 rounded-lg shadow-lg hover:cursor-pointer hover:shadow-xl transition-all">
                <div className="flex justify-between items-center">
                <span className="text-lg text-gray-600 font-semibold">April</span>
                <span className="text-xl mt-6 font-bold text-green-600">{formatCurrency(10000)}</span>
                </div>
                <div className="mt-2">
